...
from iggt.datasets.base.easy_dataset import EasyDataset
from iggt.datasets.utils.transforms import ImgNorm
...
class BaseStereoViewDataset (EasyDataset):
    ...
    def _crop_resize_if_necessary(self, image, depthmap, intrinsics, resolution, mask=None,  rng=None, info=None):
        """ This function:
