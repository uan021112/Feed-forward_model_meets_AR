...
class Kubric(BaseStereoViewDataset):
    def __init__(self,
                 dataset_location='datasets/processed_kubric',
                 use_cache = False,
                 dset='trackings',
                 z_far = 1000,
                 use_augs=False,
        ...
        if self.use_cache:
            dataset_location = 'annotations/kubric_annotations'
...
if __name__ == "__main__":
    ...
    dataset_location = 'datasets/processed_kubric'  # Change this to the correct path
    dset = 'trackings'
    use_augs = False
    num_views = 10
