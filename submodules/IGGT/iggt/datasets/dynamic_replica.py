...
class Dynamic_Replica(BaseStereoViewDataset):
    def __init__(self,
                 dataset_location='datasets/processed_dynamic_replica',
                 use_cache = True,
                 dset='train',
                 use_augs=False,
                 top_k = 256,
        ...
        if self.use_cache:
            dataset_location = "annotations/dynamic_replica_annotations"
...
if __name__ == "__main__":
    ...
    dataset_location = 'datasets/processed_dynamic_replica'  # Change this to the correct path
    dset = 'valid'
    use_augs = False
    num_views = 10
