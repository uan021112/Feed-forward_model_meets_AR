...
class Hypersim(BaseStereoViewDataset):
    def __init__(self,
                 dataset_location='datasets/processed_hypersim_new',
                 use_cache = False,
                 dset='',
                 use_augs=False,
                 top_k = 256,
        ...
        if self.use_cache:
            dataset_location = 'annotations/hypersim_annotations'
            ...
            for seq in self.sequences:
                ...
                for sub_seq in sub_scenes:
                    ...
                    if num_frames < 24:
                        print(f"Skipping sequence {sub_seq} with only {num_frames} frames.")
                        continue
...
if __name__ == "__main__":
    ...
    dataset_location = 'datasets/processed_hypersim_new'  # Change this to the correct path
    dset = ''
    use_augs = False
    num_views = 10
