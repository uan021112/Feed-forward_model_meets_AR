...
class Dl3dv(BaseStereoViewDataset):
    def __init__(self,
        ...
        if self.use_cache:
            dataset_location = 'annotations/dl3dv_annotations'
            ...
            # # 保存为 JSON 文件
            # os.makedirs(f'annotations/dl3dv_annotations/{self.dset}', exist_ok=True)
            # self._save_paths_to_json(self.all_rgb_paths, f'annotations/dl3dv_annotations/{self.dset}/rgb_paths.json')
            # self._save_paths_to_json(self.all_depth_paths, f'annotations/dl3dv_annotations/{self.dset}/depth_paths.json')
            # self._save_paths_to_json(self.all_outlier_mask_paths, f'annotations/dl3dv_annotations/{self.dset}/outlier_mask_paths.json')
            # self._save_paths_to_json(self.all_sky_mask_paths, f'annotations/dl3dv_annotations/{self.dset}/sky_mask_paths.json')
            # joblib.dump(self.rank, f'annotations/dl3dv_annotations/{self.dset}/rankings.joblib')
            # joblib.dump(self.all_extrinsic, f'annotations/dl3dv_annotations/{self.dset}/extrinsics.joblib')
            # joblib.dump(self.all_intrinsic, f'annotations/dl3dv_annotations/{self.dset}/intrinsics.joblib')
            print('found %d frames in %s (dset=%s)' % (len(self.full_idxs), dataset_location, dset))
