...
class Co3d(BaseStereoViewDataset):
    def __init__(self,
                 dataset_location='datasets/processed_co3d',
                 use_cache = False,
                 dset='train',
                 use_augs=False,
                 top_k = 256,
        ...
        if self.use_cache:
            dataset_location = 'annotations/co3dv2_annotations'
            ...
            for seq in self.sequences:
                ...
                for sub_seq in sub_scenes:
                    ...
                    if num_frames < 24:
                        print(f"Skipping sequence {sub_seq} in {seq} due to insufficient frames ({num_frames} < 24).")
                        continue
    ...
    def _get_views(self, index, num, resolution, rng):
        if num != 1:
            ...
            max_depths = [self.max_depths[full_index]]
...
if __name__ == "__main__":
    ...
    dataset_location = 'datasets/processed_co3d'  # Change this to the correct path
    dset = ''
    use_augs = False
    num_views = 10
