...
from vggt.utils.parallel import parallel_threads
import vggt.datasets.utils.cropping as cropping
...
def get_parser():
    ...
    parser.add_argument('--output_dir', default='datasets/blendedmvs_processed')
    return parser
